    ...
    def sarsa_agent(self, episodes=500, alpha=0.1, gamma=0.9, epsilon=0.1):
        ...
        for i in range(episodes):
            ...
            while not done and step < 1000:
                ...
                td_target = reward + gamma * self.Q_table1[next_x, next_y, next_action]
                td_error = td_target - self.Q_table1[x, y, action]
                self.Q_table1[x, y, action] += alpha * td_error
    ...
    def Q_learning_agent(self, episodes=500, alpha=0.1, gamma=0.9, epsilon=0.1):
        ...
        for i in range(episodes):
            ...
            while not done and step < 1000:
                ...
                # Q-learning core: use max Q value for update
                max_next_q = np.max(self.Q_table2[next_x, next_y, :])
                td_target = reward + gamma * max_next_q
                td_error = td_target - self.Q_table2[x, y, action]
                self.Q_table2[x, y, action] += alpha * td_error
